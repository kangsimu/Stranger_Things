        ...
        <div id="newPostBox">
            <form id="newPost" onSubmit={handleSubmit}>
                ...
                <input onChange = {(event) => {setTitle(event.target.value)}} 
                    type='text' title="title" value = {title} required/>
                <label className="postTitles">
                    Description:
                </label>
                <input id="descriptionID" onChange = {(event) => {setDescription(event.target.value)}}  
                    type='text' description='description' value = {description} required/>
                <label className="postTitles">
                    Location:
                </label>
                <input className="postTitles" onChange = {(event) => {setLocation(event.target.value)}} 
                    type="text" location='location' value = {location}/>
                <label className="postTitles">
                Price:
                </label>
